...
| Lab01S02 | Script de mineração de RQ01/RQ02, paginação para 1.000 repositórios, validação estatística e gráficos exploratórios | Pedro Talma Toledo | #2 |
| Lab01S02 | Script de mineração de RQ05/RQ06 (1.000 repositórios) e validação | José Miguel | #4 |
| Lab01S03 | Análise final e visualização das RQ01/RQ02, incluindo gráficos por faixas de idade e de pull requests aceitas | Pedro Talma Toledo | #7 |
| Lab01S03 | Consolidação e análise das demais RQs / RQ07 | José Miguel | #5 |
...
**RQ01 - Sistemas populares são maduros/antigos?**
![Distribuição da idade dos repositórios](LAB01S03/RQ1E2/graficos/rq01_idade_final.png)

**RQ02 - Sistemas populares recebem muita contribuição externa?**
![Boxplot de pull requests aceitas](LAB01S03/RQ1E2/graficos/rq02_pull_requests_final.png)
